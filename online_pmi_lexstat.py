...
def lexstat_concept_evaluate_scores(d, lodict, gop, gep):
    ...
    for concept in d:
        ...
        if args.clust_algo == "crp":
            ...
            clust = clust_algos.igraph_clustering(distMat, args.thd, method=args.clust_algo)
    ...
    print("F-scores ", f_scores[0], f_scores[1], 2.0*f_scores[0]*f_scores[1]/(f_scores[0]+f_scores[1]),sep="\t")
    return bin_mat
